...
def SketchTriplet(data_params, loss_params, out_dim = 20, phase = 'train',\
                  share_weights='half',loss_type=0):
...
def SketchTriplet_online(data_params, loss_params, hard_sel = 'hard_neg', out_dim = 20, phase = 'train',\
                  share_weights='half',loss_type=0):
  """Online hard mining
  """
  #wheather anchor shares weights with pos and neg network
  ...
  if phase == 'train' or phase == 'test':
    ...
    n = caffe.NetSpec()
    #data layer
    n.data_a, n.data_p, n.label_a, n.label_p = L.Python(name = 'input_data', phase = mode,
                                ntop=4, module='triplet_data_online',layer = 'TripletDataLayer',
                                param_str = str(data_params))
    ...
    #hard mining
    hm = dict(hm_type = hard_sel,asf = loss_params['anchor_scale'])
    n.fa, n.fp, n.fn = L.Python(n.feat_a, n.feat_p, n.label_a, n.label_p, name = 'hardmining',
                             ntop = 3, module='triplet_select_layer', layer = 'TripletSelectLayer',
                             param_str = str(hm))
    
    #triplet loss
    layer = 'TripletLossLayer' + str(loss_type)
    
    n.loss    = L.Python(n.fa, n.fp, n.fn, 
                         name = 'triplet_loss', loss_weight = loss_params['loss_weight'],
                         module = 'triplet_loss', layer = layer, 
                         param_str = str(loss_params))
    proto = n.to_proto()
